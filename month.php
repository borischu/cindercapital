            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-section">
                        <?php
                            print "<h1 class=\"page-title\">Opinions posted in ".$month." ".$year."</h1>";
                        ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <?php
                            $qry = "SELECT uniqueID, firstName, lastName, title, sector, content, date, month, DAY(date), YEAR(date) FROM opinions LEFT JOIN users ON opinions.userName = users.userName WHERE posted = 1 AND month = '".$month."' AND YEAR(date) = '".$year."' ORDER BY date DESC LIMIT 3 OFFSET ".($page*3-3);
...
TOP;
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            <div class="st-pagination">
                                <ul class="pagination">
                                    <?php
                                        $qry = "SELECT uniqueID FROM opinions WHERE posted = 1 AND month = '".$month."' AND YEAR(date) = '".$year."' ORDER BY date DESC LIMIT 9 OFFSET ".($page*3-3);
                                        $result = mysqli_query($connect, $qry);
                                        $rows = 0;
                                        while ($row = $result -> fetch_row()) {
                                            $rows += 1;
                                        ...
                                        if ($page == 1) { // first page
                                            ...
                                            for ($x=1; $x<=$rows; $x+=3) {
                                                if ($x % 3 == 1) {
                                                    if ($count <= 3) {
                                                        if ($count == $page) {
                                                            print "<li class=\"active\"><a href=\"?month=".$month."&year=".$year."&page=".$count."\">1</a></li>";
                                                        } else {
                                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".$count."\">".$count."</li>";   
                                                        }
                                                        $count += 1;
                                                    } else {
                                                        break;
                                            ...
                                            if ($count-2 >= $page) {
                                                print "<li><a href=\"?month=".$month."&year=".$year."&page=".($page+1)."\" aria-label=\"Next\"><span aria-hidden=\"true\">Next</span></a></li>";   
                                            }
                                        } else if ($pages *3 <= $rows && $pages * 3 >= $rows - 3) { // last page
                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".($page-1)."\" aria-label=\"Previous\"><span aria-hidden=\"true\">Previous</span></a></li>";
                                            $count = $page;
                                            for ($x=1; $x<=$rows; $x+=3) {
                                                if ($x % 3 == 1) {
                                                    if ($count <= $page+1) {
                                                        if ($count == $page) {
                                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".($count-2)."\">".($count-2)."</a></li>";
                                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".($count-1)."\">".($count-1)."</a></li>";
                                                            print "<li class=\"active\"><a href=\"#\">".$count."</a></li>";
                                                        } else {
                                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".$count."\">".$count."</a></li>";
                                                        }
                                                        $count += 1;
                                                    } else {
                                                        break;
                                            ...
                                            for ($x=1; $x<=$rows; $x+=3) {
                                                if ($x % 3 == 1) {
                                                    if ($count <= $page+1) {
                                                        if ($count == $page) {
                                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".($count-1)."\">".($count-1)."</a></li>";
                                                            print "<li class=\"active\"><a href=\"?month=".$month."&year=".$year."&page=".$count."\">".$count."</a></li>";
                                                        } else {
                                                            print "<li><a href=\"?month=".$month."&year=".$year."&page=".$count."\">".$count."</a></li>";
                                                        }
                                                        $count += 1;
