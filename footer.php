        ...
        <div class="row">
            ...
            <div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="footer-widget">
                    <h3 class="footer-title">Cinder Capital</h3>
                    <ul>
            ...
            <div class=" col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div class="footer-widget">
                    ...
                    <div class="contact-info">
                        <span class="contact-text">cindercapital@gmail.com</span>
                    </div>
                    <div class="contact-info">
                        <span class="contact-text">832-605-4350</span>
                    </div>
                </div>
            </div>
            <!-- /.footer-useful links -->
        ...
        <div class="row">
            <div class="tiny-footer">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <p>Copyright © Cinder Capital, LLC 2019</p>
                </div>
            </div>
        </div>
        <!-- /. tiny-footer -->
